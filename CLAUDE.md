...
Die drei Gebäude auf dem Streckenbild (`Rennstrecke/strecke.png`) sind an reale Hallenser Bibliotheken angelehnt: **Steintor** (links, rotes Backsteingebäude), **Neuwerk** (rechts, ockerfarbenes Türmchengebäude), **Juri** (unten/Mitte, moderner Glas-/Betonbau). Spieler können auf ein Gebäude klicken, um sich dort einzuchecken — für alle Clan-Mitglieder sichtbar als kleine rechteckige „Wild Card" (Panini-Sticker-Stil, live aus `avatar_url`/`username` gerendert, **bewusst rechteckig statt rund** und etwas kleiner als die `.lb-race-avatar`-Renn-Icons, damit beides klar unterscheidbar bleibt), Migration `20260901000000_library_checkin.sql`.
